...
if (!$es_fin_de_semana) {
?>
    <h2 id="menu" class="roboto-black">Bienvenid@, <?php echo $nombre_empleado; ?>.</p>
    ...
    <div class="tab-container">
        ...
        <span class='roboto-black'>Cupon SYM:</span> <br> <i class="fa-solid fa-glass-water"></i>
        </button> -->
        </div>
    </div>
<?php
...
<p id='menu'>© 2024, by: <a id='menu' href="mailto:eliasefmx@gmail.com">Elías Flores</a></p>
</body>
</html>